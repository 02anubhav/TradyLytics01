...
const Footer = () => {
  return (
    <footer className="w-full bg-[#0C0721] text-zinc-50">
      <div className="max-w-screen-xl mx-auto py-10 px-6 lg:px-8 flex flex-col lg:flex-row gap-12 lg:gap-32 mt-44">
        {/* Brand Section */}
